...
\begin{frame}\frametitle{\textbf{\LARGE{\textrm{What is Multi-Tenancy.}}}}
	\begin{columns}
		...
		\begin{itemize}
			...
			\item Key subjects:
				\begin{compactenum}%Latex geeft geen tellertjes? dan maar met de hand..
				\item 1. Security
				\item 2. Scalability \& QoS
				\item 3. Variability
				\end{compactenum}
		\end{itemize}
		\column{.3\textwidth}
...
%% LET OP: Eerste opzet, ga nog even nachtje slapen over of dit nu een handige slideindeling is.
%% Zet m.n. met dat nu niet de problemen, maar wel de oplossingen opgenomen zijn.
%% Probleem is dat we zo ranzig weinig tijd hebben :p.
