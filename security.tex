Like the concept of multi-tenancy itself, the security aspect of multi-tenancy is relatively new and open to more research. 
...
Though cloud computing is targeted to provide better utilization of resources using virtualization techniques and to take up much of the work load from the client, it is fraught with security risks \highlight{(Seccombe et al, 2009)}. 
...
This unique attribute poses many new security challenges \highlight{(Cong Wang et al, 2009)}. 
...
According to \highlight{(Softlayer, 2009)}, compliance and data privacy laws in various countries locality of data are of utmost importance in many enterprise architectures. 
...
To ensure the secure data storing, the paper~\cite{Takahashi2012Security} suggests the use of encrypted data manipulation using crypto-graphical techniques. 
