...
We will briefly addrese these relevant issues in this paper. 
...
However, this form of authentication lacks multi-tenancy-specific capabilities, where the user authorization is confined to each individual tenant. 
...
Noteworthy progress has been made by Bernabe~\cite{Bernabe2012Auth}, which proposes an access control model system suitable for multi-tenancy and grants high expressiveness in terms of permissions. 
