...
Often these SLAs contain certain Quality of Service constraints the provider will have to meet, such as response time or minimum uptime. 
The tenant on the other hand will also have certain quotas or a \ac{FUP}.
...
In the list 'exceeding their quota' can mean exceeding an explicitly defined limit based on the SLA or, in the case of a fair use policy, unfair use of the system.
\begin{enumerate}
