...
\title{\highlight{Investigating the state of the art of multi-tenancy: a survey}}
...
Due to the uprising of \highlight{cloud} services, more and more applications are converted into multi-tenant applications. % TODO citation! (of aan SaaS koppelen) 
