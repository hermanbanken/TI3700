...
The proposed multi-tenant aware database is still incomplete as it lacks tenant aware administration tooling and the storage model is still incomplete. 
