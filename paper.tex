...
In this section we discuss the current state of research on multi-tenancy. We do so by discussing the main topics in multi-tenancy, namely Security, Scalability and Variability. For each subject we did a literature study describing what each subject means and how it can be achieved in the context of multi-tenancy. We also address the points of interest for future research.
