...
\title{\highlight{Multi-Tenancy: ready to rock? a survey}}
...
Due to the uprising of \highlight{cloud} services, more and more applications are converted into multi-tenancy applications. % TODO citation! (of aan SaaS koppelen) 
\highlight{Multi-tenancy is \ldots} % <<--
\highlight{As a result, \ldots} % <<--
...
This literature survey merges the information of about \highlight{50 papers}, in order to create a clear view of the definitions of multi-tenancy, the challenges and the research opportunities.
...
The proposed multi-tenant aware database is still incomplete as it lacks tenant aware administration tooling and the storage model is still incomplite. 
