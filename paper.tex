...
Due to the uprising of \ac{SaaS} applications, more and more applications are converted into multi-tenant applications. % TODO citation! Verder loopt dit nog niet zo...
