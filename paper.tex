...
Our Research~Agenda provides an overview of possible research opportunities, such as automation (automatic deployment, wizards for tenants, et cetera), guarantees (solutions to new problems need to be provable) and tenant aware components (such as load balancers and databases).
\\
